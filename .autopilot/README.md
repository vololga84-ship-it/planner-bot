...
|---|---|---|---|
| 2026-09-13 | `2026-09-13-night-notes-agent` | сдан | Ночной агент: заметки из «📝 Заметки» каждый вечер сами превращаются в план/письмо/список (форму выбирает модель) и уходят автору в Telegram — Мама больше не зависит от Claude Code |
